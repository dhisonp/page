...
> TODO: Metadata, roofread, spellcheck and links
...
ChatGPT yourself all it shat out is AI slop that only Joe from marketing thought it was pretty good?

I was never at that place, but close to it. There's a small window in my career where I tried my
best to leverage LLMs to the fullest. I've seen the vibest of vibe coders but also the most
...
inadvertendly due to the nature of us being nerds, we started exchanging information on how we
...
shit out of Cursor. The finance bros, the digital marketing dude, the girl who just let Meta HR. And
I do respect them for being able to competently get involved in the tech side of things when they
have no formal education for it. It's called 'vibe' coding for a reason– they are vibing with it!
...
what Cursor is– you can easily find that online. But using Cursor in correctly will show you the
most obvious results in comparison of using other LLMs incorrect, because the environment itself
...
different dudu anytime, however they want, based on your input and prompt.
...
direction and nudge them if they do something that displease you. Yeah, just smack them if they get
...
You can begin by referring to Claude Code's Best Practices documentation. Despite how public it is,
surprisingly I see so little developers actually make use of their highly effective system that
includes agents, skills, commands, etc. But that is a topic for another day, and there are heads
more qualified to write an article about skills (which apparently is the hot shit nowadays, I need
to catch up, still!).
...
What I'm going to is how we utilize multiple, but not excessive– a minimal lineup of spec files per
task or per domain.

## Specifications

I turned Snow Bunnies from an idea into a fully working product under 5 hours with this method, and
it honestly surprised me how effective it is. What I did in order:
...
Here's the kicker, in the initial spec file, ideally it should already contain a checklsit or a
roadmap to the MVP and beyond. But you don't want each new chat to digest that absolute Babylonia of
...
design system that I was working on, but it wasn't ready. So what I did was, again, went back to
Opus 4.5 Thinking in my browser. Then I describe what my design system was, and sent two links to
websites I liked the look of, and finally say that I absolutely want a brutalist, utilitarian
design.
...
What's the point, you ask? And yes, you don't need multiple spec files is all you wanted is to
...
working on trivial stuff like centering that div (check out how I utilize parallel LLMs here).
